...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.0, spring = "snappy", style = "popin 87%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.0, spring = "snappy", style = "popin 87%" })
