...
-- Each logical desktop spans both monitors using a workspace pair:
-- Desktop 1 = workspaces 1 and 2
-- Desktop 2 = workspaces 3 and 4
-- Desktop 3 = workspaces 5 and 6
hl.workspace_rule({
    workspace = "1",
    monitor = "HDMI-A-1",
    default = true,
...
hl.on("hyprland.start", function ()
    hl.exec_cmd(
        ...
        "--silent --fps 30 " ..
        "--scaling fill --screen-root HDMI-A-1 --bg 3065386950 " ..
        "--scaling fill --screen-root DP-3 --bg 3165294744 " ..
        ">/tmp/linux-wallpaperengine.log 2>&1 & " ..
        "sleep 2; " ..
